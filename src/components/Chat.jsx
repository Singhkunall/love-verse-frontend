          ...
          return (
            <div key={index} className={`flex ${isMine ? "justify-end" : "justify-start"} animate-in slide-in-from-bottom-2`}>
              <div className={`max-w-[70%] flex flex-col ${isMine ? "items-end" : "items-start"}`}>
                <div className={`shadow-sm transition-all ${isMine ? "bg-rose-500 text-white rounded-[2rem] rounded-tr-none" : "bg-white text-gray-700 rounded-[2rem] rounded-tl-none border border-rose-50"
